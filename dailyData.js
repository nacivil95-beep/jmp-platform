/**
 * 작업일보(진천_본공사) 2026.07 - 엑셀에서 자동 추출한 일자별 실데이터
 * 생성 스크립트: extract.py (시트 01~31 파싱)
 * ※ 이 값은 "초기 기본값(폴백)"입니다. 헤더의 "작업일보 불러오기" 버튼으로
 *   최신 엑셀 파일을 선택하면 아래 값은 브라우저에서 그 자리에서 다시 파싱되어 교체됩니다.
 *
 * earth 필드: "시공 및 투입 현황" 시트의 01.토공 항목(토사/리핑암/발파암깎기/흙쌓기) 중
 *   해당 일자 "누계(H열)" 수치를 담고 있습니다. 토공사 현황 카드는 더 이상 특정 날짜
 *   (2026-07-20) 수치를 고정으로 쓰지 않고, 이 earth 필드를 날짜별로 그대로 반영합니다.
 */
let DAILY_REPORTS = {
  "01": {
    "date": "2026-07-01",
  ...
  "21": {
    ...
    "work_tomorrow": [
      "◆토공",
      " 1. 흙깎기 및 쌓기(BL.2)",
      "   - D/ZD1-1, D/T25-3, 신호수-1",
      " 2. 흙깎기 및 쌓기(BL.5, 6, 11,13)",
      "   - B/H500-2, B/H380-1, B/H0.6-2, D/T15-5, 신호수-2",
      "   - 관리자-2, 작업반장-1, D/Z11T-1",
      " 3. 발파암 소할",
      "   - B/H1.0-1",
      " 4. 정지작업 및 노면정리",
      "   - 진동롤러-1",
      " 5. 발파암 천공 및 작업면 평탄화(BL.2, 6)",
      "   - 천공기-2, B/H1.0-1, 신호수-1",
      " 6. 발파(BL.2, 6)                [126공,  6회]",
      "   - 관리자-1, 화약주임-1, 장약공-1",
      " 7. 표토제거 및 법면정리(중로(집) 3-16)",
      "   - B/H1.0-1",
      "◆부대공",
      " 1. 현장 살수",
      "   - 살수차(8ton)-1",
  ...
  "22": {
    ...
    "work_tomorrow": [
      ...
      "   - D/ZD1-1, B/H380-1, D/T25-3, 신호수-1",
      " 2. 흙깎기 및 쌓기(BL.5, 6, 11,13)",
      "   - B/H500-2, B/H0.6-2, D/T15-5, 신호수-2",
      "   - 관리자-2, 작업반장-1, D/Z11T-1",
      " 3. 발파암 소할",
      "   - B/H1.0-1",
      " 4. 정지작업 및 노면정리",
  ...
  "23": {
    ...
    "work_today": [
      ...
      "   - D/ZD1-1, B/H380-1, D/T25-3, 신호수-1",
      " 2. 흙깎기 및 쌓기(BL.5, 6, 11,13)",
      "   - B/H500-2, B/H0.6-2, D/T15-5, 신호수-1",
      "   - 관리자-2, 작업반장-1, D/Z11T-1",
      " 3. 발파암 소할",
      "   - B/H1.0-1",
      " 4. 정지작업 및 노면정리",
  ...
  "24": {
    ...
    "work_tomorrow": [
      ...
      " 3. 정지작업 및 노면정리",
      "   - 진동롤러-1",
      " 4. 발파암 천공 및 작업면 평탄화(BL.2, 6)",
      "   - 천공기-2, B/H1.0-1, 신호수-1",
      " 5. 발파(BL.2, 6)                [126공,  6회]",
      "   - 관리자-1, 화약주임-1, 장약공-1",
      " 6. 가설도로 개설 및 부지정리(은탄리 산 107-1, BL.3)",
      "   - B/H1.0-1",
      " 7. 작업로 개설 및 우죽 정리(BL.6)",
      "   - B/H1.0-1, B/H0.6-1, B/H0.2-2",
      "◆부대공",
      " 1. 현장 살수",
      "   - 살수차(8ton)-1",
      "◆기타",
  ...
  "31": {
    ...
    "work_tomorrow": [
      "◆토공",
      " 1. 흙깎기 및 쌓기(BL.2)",
      "   - D/Z10N-1, D/ZD1-1, B/H1.0-1, D/T25-2, 신호수-1",
      " 2. 흙깎기 및 쌓기(BL.5, 6, 11)",
      "   - D/Z5K-1, B/H500-2, D/T25-3, 신호수-1",
      "   - B/H380-1, B/H0.6-1, D/T15-3",
      "   - 관리자-1, 작업반장-1, D/Z11T-1, D/ZD5-1, D/T15-1",
      " 3. 발파암 소할",
      "   - B/H1.0-1",
      " 4. 가배수로 정비",
      "   - B/H0.2-1",
      ...
      "   - 그레이더-1, 진동롤러-1",
      " 6. 발파암 천공 및 작업면 평탄화(BL.5)",
      "   - 천공기-3, B/H1.0-1, 신호수-1",
      " 7. 발파(BL.5)                [220공,  7회]",
      "   - 관리자-1, 화약주임-1, 장약공-2",
      " 8. 흙깎기 및 쌓기(BL.5,13)",
      "   - 관리자-2, D/T25-3, D/T15-2, 신호수-1",
      "   - B/H500-1, B/H480-1, B/H0.6-1",
      "◆부대공",
      " 1. 현장 살수",
      "   - 살수차(8ton)-2"
    ],
