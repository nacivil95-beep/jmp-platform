...
let DAILY_REPORTS = {
  ...
  "2026-09-08": {
    ...
    "earth": {
      ...
      "흙쌓기(성토)": {
        ...
        "today": 1988.8000000000002,
        "cum": 554507.2399999999,
        "start": "2025-02-01"
      }
    },
    "work_today": [
  ...
  "2026-09-09": {
    ...
    "earth": {
      ...
      "흙쌓기(성토)": {
        "design": 7742307,
        "prev": 554507.2399999999,
        "today": 1930.5000000000002,
        "cum": 556437.7399999999,
        "start": "2025-02-01"
      }
    },
    "work_today": [
  ...
  "2026-09-10": {
    ...
    "earth": {
      ...
      "흙쌓기(성토)": {
        "design": 7742307,
        "prev": 556437.7399999999,
        "today": 5753.200000000001,
        "cum": 562190.9399999998,
        "start": "2025-02-01"
      }
    },
    "work_today": [
    ...
    "work_tomorrow": [
      "◆토공",
      " 1. 임목폐기물 파쇄 및 제근뿌리 쪼개기 작업 (BL.6)",
      "   - B/H0.6-1, B/H0.8-1, B/H0.2-3, D/T15-1, 임목파쇄기-1",
      " 2. 흙깍기 및 흙쌓기(발파암) (BL.5)",
      "   - D/ZD1-1, B/H500-1, B/H380-1, D/T25-2, 신호수-1",
      " 3. 흙깍기 및 흙쌓기(토사) (BL.22, 23)",
      "   - B/H1.0-1, D/T15-3, 신호수-1",
      " 4. 표토제거 및 성토정지 (BL.22, 23)",
      "  - B/H0.2-1",
      "◆부대공",
  ...
  "2026-09-11": {
    ...
    "earth": {
      ...
      "흙쌓기(성토)": {
        "design": 7742307,
        "prev": 562190.9399999998,
        "today": 3894.5800000000004,
        "cum": 566085.5199999998,
        "start": "2025-02-01"
      }
    },
    "work_today": [
    ...
    "work_tomorrow": [
      ...
      "   - D/ZD1-1, B/H500-1, B/H380-1, D/T25-2, 신호수-1",
      " 2. 흙깍기 및 흙쌓기(토사) (BL.22, 23)",
      "   - B/H1.0-1, D/T15-3, 신호수-1",
      " 3. 표토제거 및 성토정지 (BL.22, 23)",
      "   - B/H0.2-2",
      " 4. 기존구조물 철거(측구) 작업 (BL.22, 23)",
      "   - B/H0.6w-1",
      " 5. 임목폐기물 파쇄 및 벌개제근 작업 (BL.6)",
      "   - B/H0.6-1, B/H0.2-2, D/T15-1, 임목파쇄기-1",
      "◆부대공",
      " 1. 현장살수",
      "   - 살수차-1",
      "◆기타",
  ...
  "2026-09-12": {
    ...
    "earth": {
      ...
      "흙쌓기(성토)": {
        "design": 7742307,
        "prev": 566085.5199999998,
        "today": 3786.4800000000005,
        "cum": 569871.9999999998,
        "start": "2025-02-01"
      }
    },
    "work_today": [
  ...
  "2026-09-13": {
    ...
    "work_tomorrow": [
      "◆토공",
      " 1. 흙깍기 및 흙쌓기(발파암) (BL.5)",
      "   - D/Z11T-1, D/ZD1-1, B/H500-1, B/H380-1, D/T25-2, 신호수-1",
      " 2. 흙깍기 및 흙쌓기(토사) (BL.22, 23)",
      "   - B/H1.0-1, D/T15-4, 신호수-1",
      " 3. 표토제거 및 성토정지 (BL.22, 23)",
      "   - B/H0.2-2",
      " 4. 기존구조물 철거(측구) 작업 (BL.22, 23)",
      "   - B/H0.6w-1",
      " 5. 임목폐기물 파쇄 및 벌개제근 작업 (BL.6)",
      "   - B/H0.8-1, B/H0.6-1, B/H0.2-2, 임목파쇄기-1",
      "◆부대공",
      " 1. 현장살수",
      "   - 살수차-1",
      "◆기타",
  ...
  "2026-09-14": {
    ...
    "earth": {
      ...
      "흙쌓기(성토)": {
        "design": 7742307,
        "prev": 569871.9999999998,
        "today": 4026.5800000000004,
        "cum": 573898.5799999997,
        "start": "2025-02-01"
      }
    },
    "work_today": [
    ...
    "work_tomorrow": [
      ...
      " 6. 성토정지 (BL.22, 23)",
      "   - B/H0.2-2",
      " 7. 임목폐기물 파쇄 및 벌개제근 작업 (BL.6)",
      "   - B/H0.8-1, B/H0.6-1, B/H0.2-1, D/T15-1, 임목파쇄기-1",
      "◆부대공",
      " 1. 현장살수",
      "   - 살수차-1",
      "◆기타",
  ...
  "2026-09-15": {
    ...
    "earth": {
      ...
      "흙쌓기(성토)": {
        "design": 7742307,
        "prev": 573898.5799999997,
        "today": 7046.8,
        "cum": 580945.3799999998,
        "start": "2025-02-01"
      }
    },
    "work_today": [
    ...
    "work_tomorrow": [
      "◆토공",
      " 1. 흙깍기 및 흙쌓기(발파암) (BL.2)",
      "   - D/Z10N-1, B/H500-1, D/T25-2, 신호수-1",
      " 2. 흙깍기 및 흙쌓기(발파암) (BL.5)",
      "   - D/Z11T-1, D/ZD1-1, B/H500-2, D/T25-4, 신호수-1",
      " 3. 흙깍기 및 흙쌓기(토사) (BL.13)",
      "   - B/H380-1, D/T15-2, 신호수-1",
      " 4. 흙깍기 및 흙쌓기(토사) (BL.22, 23)",
      "   - B/H1.0-1, D/T15-3, 신호수-1",
      " 5. 성토 정지작업 (BL.12, 13)",
  ...
  "2026-09-16": {
    ...
    "earth": {
      ...
      "흙쌓기(성토)": {
        "design": 7742307,
        "prev": 580945.3799999998,
        "today": 12210.080000000002,
    ...
    "work_tomorrow": [
      ...
      "   - B/H0.2-1",
      " 7. 임목폐기물 파쇄 및 벌개제근 (BL.6)",
      "   - B/H0.8-1, B/H0.6-1, B/H0.2-3, D/T15-3, 임목파쇄기-1",
      "◆부대공",
      " 1. 현장살수",
      "   - 살수차-1",
      "◆기타",
  ...
  "2026-09-18": {
    ...
    "work_today": [
      ...
      " 6. 성토정지 (BL.12)",
      "   - B/H0.6w-1",
      " 7. 표토제거 (BL.12, ,13, 17, 25, 폐수처리장)",
      "   - B/H0.2-1",
      " 8. 임목폐기물 파쇄 및 벌개제근 (BL.6)",
      "   - B/H0.8-1, B/H0.6-1, B/H0.2-2, D/T15-3, 임목파쇄기-1",
      " 9. 기존구조물철거 (은탄리 783)",
      "   - B/H0.2-1, 철거공-2",
      "◆부대공",
    ...
    "work_tomorrow": [
      ...
      "   - D/Z6H-1, B/H500-1, D/T25-2, 신호수-1",
      " 2. 흙깍기 및 흙쌓기(발파암) (BL.5)",
      "   - D/Z11T-1, D/ZD1-1, B/H500-2, D/T25-2, D/T15-2 신호수-2",
      " 3. 흙깍기 및 흙쌓기(토사) (BL.9)",
      "   - D/Z10N-1, D/Z5K-1, B/H380-1, D/T15-2, 신호수-1",
      " 4. 법면정리 (BL.10)",
      "   - B/H1.0-1",
