...
if %errorlevel% neq 0 (
    ...
    echo Please check python installation and the openpyxl library.
    echo.
    pause
    exit /b %errorlevel%
)
...
if %errorlevel% neq 0 (
    ...
    echo Please check that the quality-test folder contains the moisture/plate-load xlsx files.
    echo.
    pause
    exit /b %errorlevel%
)
